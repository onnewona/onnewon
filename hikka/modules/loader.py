...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "select_preset": "<b>ಡ ͜ ʖ ಡ Iltimos, oldindan sozlashni tanlang</b>",
        ...
        "requirements_failed": "<b>ಡ ͜ ʖ ಡ Requirements installation failed</b>",
        "requirements_installing": "<b>(◍•ᴗ•◍) Installing requirements:\n\n{}</b>",
        "requirements_restart": "<b>(ㆁωㆁ) Requirements installed, but a restart is required for </b><code>{}</code><b> to apply</b>",
        "all_modules_deleted": "<b>(◕ᴗ◕✿) Barcha modullar o'chirildi</b>",
        "single_cmd": "\n◍ <b>{}{}</b> {}",
        "undoc_cmd": "ಡ ͜ ʖ ಡ No docs",
        "ihandler": "\n◍ <b>{}</b> {}",
        "undoc_ihandler": "ಡ ͜ ʖ ಡ No docs",
        "inline_init_failed": (
