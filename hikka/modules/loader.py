...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "no_preset": "<b>(◍•ᴗ•◍) Oldindan sozlash topilmadi</b>",
        "preset_loaded": "<b>(◕ᴗ◕✿) Oldindan sozlash yoqildi</b>",
        "no_module": "<b>(ㆁωㆁ) Modul repoda mavjud emas.</b>",
        "no_file": "<b>(ㆁωㆁ) Fayl topilmadi</b>",
        "provide_module": "<b>(◕ᴗ◕✿) Yuklash uchun modulni taqdim eting</b>",
        "bad_unicode": "<b>( ꈍᴗꈍ) Modulda Unicode formati noto‘g‘ri</b>",
        "load_failed": "<b>( ꈍᴗꈍ) Yuklanmadi. Tafsilotlar uchun jurnallarga qarang.</b>",
        "loaded": "<b>◍ Modul </b><code>{}</code>{}<b> oʻrnatildi {}</b>{}{}{}",
        "no_class": "<b>Qaysi sinfni tushirish kerak?</b>",
        "unloaded": "<b>( ꈍᴗꈍ) Modul olib tashlandi.</b>",
        "not_unloaded": "<b>( ꈍᴗꈍ) Modul olib tashlanmadi.</b>",
        "requirements_failed": "<b>◉ Talablarni o'rnatib bo'lmadi</b>",
        "requirements_installing": "<b>(◍•ᴗ•◍) O'rnatish talablari:\n\n{}</b>",
        "requirements_restart": "<b>(ㆁōㆁ) Talablar o'rnatilgan, ammo </b><code>{}</code><b> qo'llanilishi</b> uchun qayta ishga tushirish kerak",
        "all_modules_deleted": "<b>(◕ᴗ◕✿) Barcha modullar o'chirildi</b>",
        "single_cmd": "\n◍ <b>{}{}</b> {}",
        "undoc_cmd": "◉ Hujjat yo'q",
        "ihandler": "\n◍ <b>{}</b> {}",
        "undoc_ihandler": "◉ Hujjat yo'q",
        "inline_init_failed": ("✯ <b>Ushbu modul Soso inline xususiyatini talab qilmaydi. "),
        "version_incompatible": "✯ <b>Ushbu modul Soso {}+ talab qiladi\nIltimos, </b><code>.update</code> bilan yangilang.",
        "ffmpeg_required": "✯ <b>Ushbu modul o'rnatilmagan FFMPEG-ni talab qiladi</b>",
        "developer": "\n\n◍ <b>Meta yaratuvchi: </b><code>{}</code>",
        "module_fs": "✿ <b>Ushbu modulni fayl tizimiga saqlamoqchimisiz, shuning uchun u qayta ishga tushirilgandan keyin yuklab olinmaydimi?</b>",
        "save": "✿ Saqlash",
        "no_save": "✯ Saqlamaslik",
        "save_for_all": "✿ Har doim fs ga saqlang",
        "never_save": "✯ Hech qachon fs ga saqlaslik",
        "will_save_fs": "✿ Endi .loadmod bilan yuklangan barcha modullar fayl tizimiga saqlanadi",
        "add_repo_config_doc": "Yuklash uchun qo'shimcha reposlar",
        "share_link_doc": ".dlmod natija xabarida modul havolasini almashish",
        "modlink": "\n◍ <b>Havola: </b><code>{}</code>",
    } 
