...
class Gallery(InlineUnit):
        ...
        *,
        ...
        if isinstance(message, Message) and not silent:
            try:
                ...
                )("<b>(◕ᴗ◕✿) Inlayn galereya sosilashmoqda...</b>")
            except Exception:
                status_message = None
        else:
            status_message = None
    ...
    async def _gallery_slideshow(
        ...
        if not self._units[unit_id].get("slideshow", False):
            ...
            await call.answer("(◕ᴗ◕✿) Slayd-shou yoqilgan")
        else:
            ...
            await call.answer("( ꈍᴗꈍ) Slayd-shou oʻchirilgan")
            return
    ...
    def _gallery_markup(self, unit_id: str) -> InlineKeyboardMarkup:
        ...
        markup.add(
            ...
            InlineKeyboardButton(
                "slayd-shou" if not self._units[unit_id].get("slideshow", False) else "pause",
